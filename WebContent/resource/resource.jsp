<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<link rel="shortcut icon" href="resource/images/minus.png" />
...
<script src="resource/js/jquery.colorpicker.js"></script>
<script
	src="https://cdn.bootcss.com/bootstrap/4.0.0-beta/js/bootstrap.min.js"></script>
<!-- 百度地图 -->
<script
	src="https://api.map.baidu.com/api?v=3.0&ak=S9eC9hSo7haHPpzXiXtv7rApqfeVnIip"></script>
<script
...
<script src="http://lbsyun.baidu.com/custom/stylelist.js"></script>
